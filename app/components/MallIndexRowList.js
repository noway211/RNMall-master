         ...
         <TouchableWithoutFeedback onPress={() => AndroidJumpModule.jumpByUrl(JSON.stringify(item.jump))}>
            <View style={styles.rowItemRoot}>
                <View style={styles.imageRoot}>
                    <Image style={styles.icon} source={{uri:item.waterMark}} resizeMode={'contain'} resizeMethod={'resize'}/>
                    <Image style={styles.itemImage} source={{uri:resizeImgByWidth(item.image,(width - 20)*2/7)}} resizeMode={'contain'} resizeMethod={'resize'}/>
                </View>
